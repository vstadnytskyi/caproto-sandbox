...
from caproto_sandbox.pyepics import PVImage
...
class GUI(wx.Frame):
    ...
    def create_GUI(self):
        ...
        self.fields['graph0']  = PVImage(self.panel, pv=f'bitmap_generator:image', im_size = (768,216))
        ...
        self.sizers[b'server'] = wx.BoxSizer(wx.VERTICAL)
        self.labels[b'server'] = wx.StaticText(self.panel, label= "server name", size = (200,-1))
        self.fields[b'server'] = epics.wx.PVText(self.panel, pv= f'bitmap_generator:t1', size = (768,216))
        self.fields[b'server'].SetBackgroundColour((0,0,255))
        ...
        self.sizer_left.Add(self.sizers[b'server'],0)
