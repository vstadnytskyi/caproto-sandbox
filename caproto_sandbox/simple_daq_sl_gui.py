...
class PanelTemplate(wx.Frame):
        ...
        def initialize_GUI(self):
            ...
            self.field[b'time'] = epics.wx.PVText(self.panel, pv='simple_sl:TIME',minor_alarm = wx.Colour(5, 6, 7),auto_units = True, size = (100,20))
            ...
            self.field[b'cpu'] = epics.wx.PVText(self.panel, pv='simple_sl:CPU',minor_alarm = wx.Colour(5, 6, 7),auto_units = True, size = (100,20))
            ...
            self.field[b'memory'] = epics.wx.PVText(self.panel, pv='simple_sl:MEMORY',minor_alarm = wx.Colour(5, 6, 7),auto_units = True, size = (100,20))
            ...
            self.field[b'battery'] = epics.wx.PVText(self.panel, pv='simple_sl:BATTERY',minor_alarm = wx.Colour(5, 6, 7),auto_units = True, size = (100,20))
